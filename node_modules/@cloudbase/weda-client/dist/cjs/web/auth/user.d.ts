...
import { IWebSiginParams, IWebUserInfo, IWebUserInfoFromSDK, IUserAllInfo, IWedaHostUser, IWebAppInfo } from '../../types/web';
 ...
 * @param params
 */
export declare function signIn(params: IWebSiginParams): Promise<void>;
/**
 * window._WedaHostConfig.wedaUser 的值跟currentUser还不一样，要保持合现网工作台一样
 * 只在登录的时候更新。getUserInfo不要更新，避免影响工作台！！
 * @returns
 */
export declare function initWedaHostUser(): Promise<void>;
/**
 ...
 * @returns
 */
export declare function transformWedaHostUser(wedaUser: any, userAllInfo: IUserAllInfo): IWedaHostUser;
/**
 * 登出
 ...
 * @returns
 */
export declare function onLoginStateChanged(cb: ({ userInfo, appInfo }: {
    userInfo: IWebUserInfo;
    appInfo: IWebAppInfo;
}) => void): Promise<void>;
/**
 ...
 * @returns
 */
export declare function getUserAllInfo(): Promise<any>;
/**
 ...
 * @returns
 */
export declare function getUserInfoFromCloudSDK(force?: boolean): Promise<IWebUserInfoFromSDK>;
/**
 * 过滤为标准的userInfo参数
 * @param wedaUser
 * @returns
 */
export declare function filterCloudSdkUserInfo(wedaUser: any): IWebUserInfoFromSDK;
/**
 * 获取用户信息
 ...
 * @returns
 */
export declare function getUserInfo(force?: boolean): Promise<IWebUserInfo>;
/**
 * 返回accessToken字符串
