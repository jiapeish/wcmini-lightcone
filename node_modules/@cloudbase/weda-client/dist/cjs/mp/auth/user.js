...
exports.loginScope = exports.getAccessToken = exports.getUserInfo = exports.filterCloudSdkUserInfo = exports.getUserInfoFromCloudSDK = exports.getWedaUserList = exports.signOut = exports.signIn = exports.userObj = void 0;
/**
...
const request_1 = require("../../common/models/request");
...
exports.userObj = {
     ...
     */
    get currentUser() {
        wedaUserInfo = filterCloudSdkUserInfo(weda_cloud_sdk_1.CLOUD_SDK.currentUser);
        /**
         * 这里如果获取的很早
         * openId 会为空，不符合直觉
         */
...
async function signIn(params) {
    try {
        const cloud = await weda_cloud_sdk_1.CLOUD_SDK.getCloudInstance();
        const { auth } = cloud;
        const envId = (0, weda_cloud_sdk_1.getConfig)('envID');
        const tokenRes = await weda_cloud_sdk_1.CLOUD_SDK.callWedaApi({
        ...
        const signInRes = await weda_cloud_sdk_1.CLOUD_SDK.signIn({ userType: 'externalUser', force: true });
...
async function getWedaUserList(params) {
    return (0, request_1.callWedaApiFn)('DescribeWedaUserList', {
        EnvId: params.envId,
        PageNo: 1,
        PageSize: 10,
...
async function getUserInfoFromCloudSDK(force = false) {
    try {
        const [wedaUser, wxContext] = await Promise.all([weda_cloud_sdk_1.CLOUD_SDK.getUserInfo(force), app_1.app.utils.getWXContext()]);
        ...
        weda_cloud_sdk_1.CLOUD_SDK?.setCurrentUserInfo?.({ wxOpenId });
        return {
            ...wedaUserInfo,
            openId: wxOpenId,
        };
