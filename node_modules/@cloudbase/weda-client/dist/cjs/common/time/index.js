...
exports.IsToday = exports.TimeText = exports.DateText = exports.YearDiff = exports.MonthDiff = exports.SecondDiff = exports.MinuteDiff = exports.HourDiff = exports.DateDiff = exports.YearAdd = exports.MonthAdd = exports.DateAdd = exports.AgeOfNow = exports.Age = exports.DateTimeValue = exports.GetDate = exports.Year = exports.Month = exports.DayOfWeek = exports.Day = exports.Hour = exports.Minute = exports.Second = exports.Timestamp = exports.Now = void 0;
 ...
 */
function Now() {
    const time = (0, vender_1.dayjs)().valueOf();
    return time;
}
exports.Now = Now;
/**
...
function Timestamp(arg) {
    let res = 0;
    try {
        res = (0, vender_1.dayjs)(arg).valueOf();
    }
    catch (e) {
        throw e;
    }
...
function Second(arg) {
    let res = 0;
    try {
        res = (0, vender_1.dayjs)(arg).second();
    }
    catch (e) {
        throw e;
    }
...
function Minute(arg) {
    let res = 0;
    try {
        res = (0, vender_1.dayjs)(arg).minute();
    }
    catch (e) {
        throw e;
    }
...
function DayOfWeek(arg) {
    let res = 0;
    try {
        res = (0, vender_1.dayjs)(arg).isoWeekday();
    }
    catch (e) {
        throw e;
    }
...
function Month(arg) {
    let res = 0;
    try {
        res = (0, vender_1.dayjs)(arg).month() + 1;
    }
    catch (e) {
        throw e;
    }
 ...
 */
function DateTimeValue(arg, val) {
    let res;
    try {
        res = (0, vender_1.dayjs)(arg, val).valueOf();
    }
    catch (e) {
        throw e;
    }
 ...
 */
function Age(arg, val) {
    let res;
    let firstAge;
    let lastAge;
    try {
        firstAge = (0, vender_1.dayjs)(arg).valueOf();
        lastAge = (0, vender_1.dayjs)(val).valueOf();
        res = vender_1.dayjs.duration(lastAge - firstAge).asYears();
        if (res >= 0) {
            // 取整
 ...
 */
function AgeOfNow(arg) {
    let res;
    let firstAge;
    let lastAge;
    try {
        firstAge = (0, vender_1.dayjs)(arg).valueOf();
        lastAge = (0, vender_1.dayjs)().valueOf();
        res = vender_1.dayjs.duration(lastAge - firstAge).asYears();
        if (res >= 0) {
            // 取整
            return Math.trunc(res);
 ...
 */
function DateAdd(arg, day) {
    let res;
    try {
        res = (0, vender_1.dayjs)(arg).add(day, 'days').valueOf();
    }
    catch (e) {
        throw e;
    }
 ...
 */
function MonthAdd(arg, month) {
    let res;
    try {
        res = (0, vender_1.dayjs)(arg).add(month, 'months').valueOf();
    }
    catch (e) {
        throw e;
    }
 ...
 */
function YearAdd(arg, year) {
    let res;
    try {
        res = (0, vender_1.dayjs)(arg).add(year, 'years').valueOf();
    }
    catch (e) {
        throw e;
    }
...
function DateDiff(startDay, endDay) {
    let res;
    try {
        res = (0, vender_1.dayjs)(endDay).diff((0, vender_1.dayjs)(startDay), 'days');
    }
    catch (e) {
        throw e;
    }
 ...
 */
function HourDiff(startDay, endDay) {
    let res;
    try {
        res = (0, vender_1.dayjs)(endDay).diff((0, vender_1.dayjs)(startDay), 'hours');
    }
    catch (e) {
        throw e;
    }
 ...
 */
function MinuteDiff(startDay, endDay) {
    let res;
    try {
        res = (0, vender_1.dayjs)(endDay).diff((0, vender_1.dayjs)(startDay), 'minutes');
    }
    catch (e) {
        throw e;
    }
 ...
 */
function SecondDiff(startDay, endDay) {
    let res;
    try {
        res = (0, vender_1.dayjs)(endDay).diff((0, vender_1.dayjs)(startDay), 'seconds');
    }
    catch (e) {
        throw e;
    }
 ...
 */
function MonthDiff(startDay, endDay) {
    let res;
    try {
        res = (0, vender_1.dayjs)(endDay).diff((0, vender_1.dayjs)(startDay), 'months');
    }
    catch (e) {
        throw e;
    }
 ...
 */
function YearDiff(startDay, endDay) {
    let res;
    try {
        res = (0, vender_1.dayjs)(endDay).diff((0, vender_1.dayjs)(startDay), 'years');
    }
    catch (e) {
        throw e;
    }
 ...
 */
function DateText(createdTime, text) {
    let res;
    try {
        res = (0, vender_1.dayjs)(createdTime).format(text);
    }
    catch (e) {
        throw e;
    }
 ...
 */
function TimeText(createdTime, text) {
    let res;
    try {
        ...
        res = (0, vender_1.dayjs)(date).format(text);
    }
    catch (e) {
        throw e;
    }
...
function IsToday(date) {
    let res;
    try {
        res = (0, vender_1.dayjs)(date).isSame((0, vender_1.dayjs)(), 'day');
    }
    catch (e) {
        throw e;
    }
