...
exports.getLoginState = exports.getTcbInstance = exports.getCustomWedaConfig = void 0;
...
function getCustomWedaConfig() {
    let config;
    try {
        config = (0, common_1.getConfig)('customConfig');
    }
    catch (e) { }
...
async function _getTcbInstance(envID) {
    const cloudbase = js_sdk_1.default;
    ...
    if (adapter) {
        try {
            ...
            const options = genOauthAdaper({
                generateOauthClientRequest: common_1.generateOauthClientRequest,
                OauthClientStorgeBase: common_1.OauthClientStorgeBase,
            });
...
function getTcbInstance() {
    return (0, common_1.execOnce)(_getTcbInstance, (0, common_1.getConfig)().envID);
}
