...
exports.callFunction = exports.createDsApiProxy = exports.callGraphql = exports.callDataSource = exports.getCloudInstance = void 0;
...
async function getCloudInstance() {
    const initTcb = (0, common_1.getConfig)('initTcb');
    const { app } = await initTcb();
    return app;
}
exports.getCloudInstance = getCloudInstance;
/**
 * 发起数据源请求
 */
async function callDataSource(originalParams) {
    var _a, _b;
    ...
    const requestData = Object.assign(params.extraParams || {}, {
        dataSourceName,
        methodName,
        defaultParams: (0, common_1.getDefaultParams)(dataSourceName, options),
        params: params.params,
    });
    try {
        // 若有自定义的调用数据源实现, 则使用自定义的实现
        const customCallDataSource = (0, common_1.getConfig)('customCallDataSource');
        if (customCallDataSource) {
            const customResp = await customCallDataSource(Object.assign({}, requestData, { parseBusinessInfo }));
            return customResp;
        }
        const beforeRequest = (0, common_1.getConfig)('beforeDSRequest');
        if (beforeRequest)
            beforeRequest(params);
        const resp = await callFunction({
            // 使用数据源名称
            name: (0, common_1.getCommonCloudFnName)(true),
            data: requestData,
        }, {
            unwrapResult: true,
            parseBusinessInfo,
        ...
        const afterRequest = (0, common_1.getConfig)('afterDSRequest');
        if (afterRequest)
        ...
        if (parseBusinessInfo) {
            const formattedError = (0, error_normalize_1.normalizeMessage)(error, {
 ...
 * 调用数据源 graphql
 */
async function callGraphql(params) {
    try {
        const beforeRequest = (0, common_1.getConfig)('beforeDSRequest');
        // @ts-ignore
        if (beforeRequest)
 ...
 */
function createDsApiProxy(parseBusinessInfo, customHandler) {
    return new Proxy({}, {
        get(t1, dsName) {
            if (customHandler) {
...
exports.createDsApiProxy = createDsApiProxy;
async function getCallFunctionRes(params, extraOptions) {
        ...
        if (MODE_API_MAP[methodName || ''] && (app === null || app === void 0 ? void 0 : app.models)) {
            ...
            try {
                res = ((_e = extraOptions === null || extraOptions === void 0 ? void 0 : extraOptions.swr) === null || _e === void 0 ? void 0 : _e.swrMode)
                    ? await (0, swr_1.default)(params2Model, func.bind(app), extraOptions === null || extraOptions === void 0 ? void 0 : extraOptions.swr)
    ...
    return ((_f = extraOptions === null || extraOptions === void 0 ? void 0 : extraOptions.swr) === null || _f === void 0 ? void 0 : _f.swrMode)
        ? await (0, swr_1.default)(params, app.callFunction.bind(app), extraOptions === null || extraOptions === void 0 ? void 0 : extraOptions.swr)
        : await app.callFunction(params);
}
/**
 * 调用云开发云函数
 */
async function callFunction(params, extraOptions) {
    var _a;
    let newParams = (0, common_1.deepClone)(params);
    // 在调用参数中注入当前环境类型, 方便服务器端调用时处理
    const isProd = (0, common_1.getConfig)('isProd');
    // 增加环境类型信息
    const extraParams = {
        /** 微搭应用ID */
        wedaAppId: (0, common_1.getConfig)('appID'),
        userAgent: config_1.cloudConfig.userAgent,
        referrer: (0, config_1.getReferrer)(),
        envType: isProd ? 'prod' : 'pre',
        wedaTarget: (0, common_1.getConfig)('wedaTarget'),
        /** cloud-sdk 版本号, 方便调试使用 */
        'x-cloud-sdk-version': config_1.VERSION,
    };
    // eslint-disable-next-line no-param-reassign
    newParams.data = Object.assign({}, newParams.data, extraParams);
    const beforeCallFunction = (0, common_1.getConfig)('beforeCallFunction');
    if (beforeCallFunction) {
        // @ts-ignore
        newParams = await beforeCallFunction(newParams);
    }
    let resp;
    const afterCallFunction = (0, common_1.getConfig)('afterCallFunction');
    try {
        newParams = getWhereData(newParams);
        (0, swr_1.judgeToClearCache)(newParams);
    ...
    if (extraOptions === null || extraOptions === void 0 ? void 0 : extraOptions.unwrapResult) {
        ...
        throw new common_1.TCBError(result === null || result === void 0 ? void 0 : result.code, result === null || result === void 0 ? void 0 : result.message, resp);
    }
    return resp;
}
