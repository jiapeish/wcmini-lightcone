...
export const DEFAULT_CACHE_TIME = 20000; // 默认缓存20s
...
export const CACHE_FILTER_METHOD = [
    'callWedaApi',
];
export const judgeToClearCache = (params) => {
    const { methodName } = (params === null || params === void 0 ? void 0 : params.data) || {};
    if (!CACHE_METHOD.includes(methodName) && !CACHE_FILTER_METHOD.includes(methodName)) {
        cache = new Map();
    }
};
const swr = async (params, fetcher, options = {}, swrKey) => {
    ...
    const time = cacheTime || DEFAULT_CACHE_TIME;
